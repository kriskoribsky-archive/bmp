 ...
 * @param image the image
 * @param factor the ratio of corresponding sides of original and created image, factor > 1 created image is larger, factor < 1 created image is smaller
 ...
 *
 * @param image the image
 * @param start_y top-left corner position on y-axis of selected area in the range <0, image->height>
 * @param start_x top-left corner position on x-axis of selected area in the range <0, image->width>
 * @param height the height of selected area in pixels in the range <1, image->height>
 * @param width the width of selected area in pixels in the range <1, image->width>
 ...
 *
 * @param image the image
 * @param colors_to_keep [bgr],b-blue, g-green, r-red
